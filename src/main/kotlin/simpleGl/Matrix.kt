...
data class Matrix4(
    ...
    companion object {
        fun identity() = Matrix4(1f,0f,0f,0f, 0f,1f,0f,0f,0f, 0f,1f, 0f, 0f, 0f, 0f, 1f)
...
operator fun Matrix4.times(v: Vector3) = Vector3(
        a * v.x + b * v.y + c * v.z + d,
        e * v.x + f * v.y + g * v.z + h,
        i * v.x + j * v.y + k * v.z + l
)
operator fun Matrix4.times(x: Matrix4) = Matrix4(
